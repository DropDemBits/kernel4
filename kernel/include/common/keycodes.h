...
#define KEY_R_ARROW 0x4f
#define KEY_L_ARROW 0x50
#define KEY_D_ARROW 0x51
#define KEY_U_ARROW 0x52
...
/*xE8*/ KEY_RESERVED, KEY_END, KEY_RESERVED, KEY_L_ARROW,\
/*xEC*/ KEY_HOME, KEY_RESERVED, KEY_RESERVED, KEY_RESERVED,\
/*xF0*/ KEY_INSERT, KEY_DELETE, KEY_D_ARROW, KEY_RESERVED,\
/*xF4*/ KEY_R_ARROW, KEY_U_ARROW, KEY_RESERVED, KEY_PAUSE,\
...
/*x98*/ KEY_U_ARROW, KEY_PG_UP, KEY_RESERVED, KEY_L_ARROW,\
/*x9C*/ KEY_RESERVED, KEY_R_ARROW, KEY_RESERVED, KEY_END,\
/*xA0*/ KEY_D_ARROW, KEY_PG_DOWN, KEY_INSERT, KEY_DELETE,\
